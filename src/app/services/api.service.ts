...
export class ApiService {
  ...
  public getToken(): Observable<any> {
    return this.http.post(`${environment.apiUrl}v1/token`, {});
  }

  public deleteToken(): Observable<any> {
    return this.http.delete(`${environment.apiUrl}v1/token`);
  }

  public getCities(): Observable<any> {
    return this.http.get(`${environment.apiUrl}v1/resources/Cities?ActiveOnly=true`);
  }

  public searchAvailability(origin: string, destination: string, beginDate: Date): Observable<any> {
    return this.http.post(`${environment.apiUrl}v1/availability/search/simple`, {
      'origin': 'SLC',
      'destination': 'DEN',
  ...
  public sellTrip(journey: object): Observable<any> {
    return this.http.post(`${environment.apiUrl}v2/trip/sell`, {
      'preventOverlap': true,
      'keys': [
        {
  ...
  public savePassenger(passengerKey: string, firstName: string, lastName: string): Observable<any> {
    return this.http.patch(`${environment.apiUrl}v2/booking/passengers/${passengerKey}`, {
      'passenger': {
        'name': {
          'first': firstName,
          'last': lastName
  ...
  public addPrimaryContact(firstName: string, lastName: string, phoneNumber: string): Observable<any> {
    return this.http.post(`${environment.apiUrl}v1/booking/contacts/primary`, {
      'phoneNumbers': [
        {
          'type': 'Other',
          'number': phoneNumber
  ...
  public savePrimaryContact(firstName: string, lastName: string, phoneNumber: string): Observable<any> {
    return this.http.put(`${environment.apiUrl}v1/booking/contacts/primary`, {
      'phoneNumbers': [
        {
          'type': 'Other',
          'number': phoneNumber
  ...
  public getBooking(): Observable<any> {
    return this.http.get(`${environment.apiUrl}v1/booking`);
  }

  public commitBooking(): Observable<any> {
    return this.http.post(`${environment.apiUrl}v1/booking`, {});
  }
}
