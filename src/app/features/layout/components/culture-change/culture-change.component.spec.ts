...
import { CoreState, reducers, CultureUpdateCulture } from '../../../../core';
...
describe('CultureChangeComponent', () => {
	...
	it('should dispatch update culture action', () => {
		const action1 = new CultureUpdateCulture({ cultureCode: 'en-US' });
	...
	it('should toggle to es-PR', () => {
		const action1 = new CultureUpdateCulture({ cultureCode: 'es-PR' });
