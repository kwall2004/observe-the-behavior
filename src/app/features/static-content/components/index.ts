...
export * from '../components/advertise/advertise.component';
export * from '../components/special-events/special-events.component';
export * from '../components/more-go/more-go.component';
...
export * from '../components/spirit-specials/spirit-specials.component';
